...
/* harmony import */ var js_sha512__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! js-sha512 */ "./node_modules/js-sha512/src/sha512.js");
/* harmony import */ var _ethersproject_random__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ethersproject/random */ "./node_modules/@ethersproject/random/lib.esm/random.js");
/**
...
function genRandomNumber(numberOfBytes) {
    ...
    return _ethersproject_bignumber__WEBPACK_IMPORTED_MODULE_1__.BigNumber.from((0,_ethersproject_random__WEBPACK_IMPORTED_MODULE_2__.randomBytes)(numberOfBytes)).toBigInt();
}
/**
...
var Identity = /** @class */ (function () {
    ...
    function Identity(identityOrMessage) {
        ...
        if (!isJsonArray(identityOrMessage)) {
            var h = js_sha512__WEBPACK_IMPORTED_MODULE_0__.sha512(identityOrMessage).padStart(128, "0");
        ...
        this._trapdoor = _ethersproject_bignumber__WEBPACK_IMPORTED_MODULE_1__.BigNumber.from(trapdoor).toBigInt();
        this._nullifier = _ethersproject_bignumber__WEBPACK_IMPORTED_MODULE_1__.BigNumber.from(nullifier).toBigInt();
        this._secret = poseidon2_2([this._nullifier, this._trapdoor]);
        this._commitment = poseidon1_2([this._secret]);
    }
...
/******/ })()
;
//# sourceMappingURL=jurorIdentifier.js.map