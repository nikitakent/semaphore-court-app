...
/* harmony export */ });
/* harmony import */ var _zk_kit_incremental_merkle_tree__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @zk-kit/incremental-merkle-tree */ "./node_modules/@zk-kit/incremental-merkle-tree/dist/index.mjs");
...
function hash(message) {
    message = _ethersproject_bignumber__WEBPACK_IMPORTED_MODULE_1__.BigNumber.from(message).toTwos(256).toHexString();
    message = (0,_ethersproject_bytes__WEBPACK_IMPORTED_MODULE_2__.zeroPad)(message, 32);
    return BigInt((0,_ethersproject_keccak256__WEBPACK_IMPORTED_MODULE_3__.keccak256)(message)) >> BigInt(8);
}
...
var Group = /** @class */ (function () {
    ...
    function Group(id, treeDepth, members) {
        ...
        this._id = id;
        this.merkleTree = new _zk_kit_incremental_merkle_tree__WEBPACK_IMPORTED_MODULE_0__.IncrementalMerkleTree(poseidon2_2, treeDepth, hash(id), 2, members.map(BigInt));
    }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   IncrementalMerkleTree: () => (/* binding */ IncrementalMerkleTree)
/* harmony export */ });
/**
...
var juryForm = document.getElementById('juryForm');
var submittedCaseDiv = document.getElementById('submittedCase');
var nextBtn = document.getElementById('nextBtn');
juryForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var caseName = document.getElementById('caseName').value;
    var caseID = document.getElementById('caseID').value;
    var treeDepth = document.getElementById('treeDepth').value;
    // ... similarly retrieve other form values
    var group = new _semaphore_protocol_group__WEBPACK_IMPORTED_MODULE_0__.Group(caseID, Number(treeDepth));
    console.log(group.id, group.depth);
    ;
    console.log(group);
    // For demonstration, just display the data without the image
    submittedCaseDiv.innerHTML = " \n        Case Name: ".concat(caseName, "<br>\n        Case ID: ").concat(caseID, "<br>\n        Tree Depth: ").concat(treeDepth, "</br>\n    ");
